---
title: Concepts
description: The five words to understand DQL.
---
...
`.run.json` that's git-ignored by default — see [Run Snapshots](/reference/file-formats/#run-snapshots)).
...
With that mental model loaded, [the guides](/guides/) all make sense.
