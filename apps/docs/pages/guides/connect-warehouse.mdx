...
description: Point DQL at Postgres, DuckDB, Snowflake, BigQuery, Redshift, or any of the 15 supported warehouses.
---
...
Per-driver options live in the [Connector reference](/reference/connectors/).
