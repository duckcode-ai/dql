...
.dql-studio-v2-intro .eyebrow { display:inline-flex; align-items:center; gap:7px; color:var(--accent); font-size:13.5px; font-weight:750; text-transform:uppercase; letter-spacing:.1em; }
...
.dql-studio-v2-start-card { background:var(--bg-2); border:1px solid var(--border-default); border-radius:20px; padding:26px; box-shadow:0 18px 54px color-mix(in srgb,var(--text-primary) 7%,transparent); display:grid; gap:22px; }
.mode-switch { background:var(--bg-0); border-radius:12px; padding:4px; display:grid; grid-template-columns:1fr 1fr; gap:4px; }
.mode-switch button { border:0; border-radius:9px; background:transparent; padding:11px 10px; color:var(--text-secondary); display:flex; align-items:center; justify-content:center; gap:8px; font-size:13px; font-weight:700; white-space:nowrap; }
...
.primary-field > span, .launch-label { font-size:13.5px; font-weight:750; color:var(--text-secondary); }
...
.ai-launch-explainer > span { width:32px; height:32px; flex:none; border-radius:9px; display:grid; place-items:center; color:var(--accent); background:var(--bg-2); }
.ai-launch-explainer > div { display:grid; gap:3px; }
.ai-launch-explainer strong { font-size:13px; line-height:1.35; }
.ai-launch-explainer small { color:var(--text-tertiary); font-size:12.5px; line-height:1.45; }
...
.studio-source-policy-row small { color:var(--text-tertiary); font-size:12.5px; line-height:1.4; }
...
.policy-toggle b { font-size:13.5px; }
...
.launch-next-step { display:block; margin-top:-13px; color:var(--text-tertiary); font-size:12.5px; text-align:center; line-height:1.4; }
.recent-drafts { grid-column:2; display:grid; gap:8px; }
.recent-drafts > header { color:var(--text-tertiary); font-size:13.5px; font-weight:700; display:flex; align-items:center; gap:6px; }
...
.dql-studio-v2-loading > div > button { margin-top:7px; border:1px solid var(--border-default); border-radius:8px; background:var(--bg-1); padding:8px 12px; font-size:13px; font-weight:700; }
.studio-ai-activity-label { min-height:18px; color:var(--accent) !important; font-size:13.5px !important; font-weight:800; }
.studio-ai-activity-actions { display:flex; justify-content:center; flex-wrap:wrap; gap:7px; }
.dql-studio-v2-loading .studio-ai-activity-actions > button { margin-top:7px; border:1px solid var(--border-default); border-radius:8px; background:var(--bg-1); padding:8px 12px; font-size:13px; font-weight:700; }
...
.source-catalog-empty small { color:var(--text-tertiary); font-size:12.5px; line-height:1.45; }
.source-catalog-empty code { font-size:12px; }
.source-catalog-empty .primary { justify-self:start; border:0; border-radius:7px; background:var(--accent); color:var(--accent-fg); font:inherit; font-size:13px; font-weight:700; padding:6px 10px; cursor:pointer; }
...
.page-nav > button:not(.icon) { border:0; background:transparent; padding:8px 11px; border-radius:8px; color:var(--text-tertiary); font-size:13.5px; font-weight:700; white-space:nowrap; }
...
.breakpoints { display:flex; background:var(--bg-0); border-radius:9px; padding:3px; }
...
.studio-actions .publish { border:0; border-radius:8px; background:var(--accent); color:var(--accent-fg); padding:9px 13px; font-size:13px; font-weight:800; white-space:nowrap; display:flex; align-items:center; gap:6px; }
.studio-actions .publish small { padding-left:6px; border-left:1px solid color-mix(in srgb,var(--accent-fg) 34%,transparent); color:inherit; font-size:11.5px; font-weight:750; }
.studio-actions .preview { border:1px solid var(--border-default); border-radius:8px; background:var(--bg-1); color:var(--text-primary); padding:8px 11px; font-size:13px; font-weight:750; white-space:nowrap; display:flex; align-items:center; gap:6px; }
.studio-actions .preview:hover { border-color:var(--border-strong); background:var(--bg-0); }
.studio-actions .copilot { border:1px solid var(--border-default); border-radius:8px; background:var(--bg-1); color:var(--text-primary); padding:8px 10px; font-size:13px; font-weight:750; white-space:nowrap; display:flex; align-items:center; gap:6px; }
...
.studio-overflow-menu { position:absolute; z-index:20; top:43px; right:10px; width:174px; padding:5px; border:1px solid var(--border-default); border-radius:9px; background:var(--bg-2); box-shadow:0 12px 34px color-mix(in srgb,var(--text-primary) 14%,transparent); }
.studio-overflow-menu button { width:100%; border:0; border-radius:6px; background:transparent; color:#b91c1c; padding:9px; display:flex; align-items:center; gap:7px; text-align:left; font-size:13px; font-weight:750; }
.studio-overflow-menu button:hover { background:color-mix(in srgb,#dc2626 9%,var(--bg-2)); }
...
.studio-left > nav button { border:0; background:transparent; border-radius:9px; padding:8px 3px; min-height:48px; color:var(--text-tertiary); display:flex; flex-direction:column; align-items:center; justify-content:center; gap:4px; font-size:12.5px; }
...
.studio-list > button > span, .filter-list > button > span, .filter-list > div > span, .template-list > button > span { width:28px; height:28px; flex:none; border-radius:7px; background:var(--bg-0); display:flex; align-items:center; justify-content:center; color:var(--text-tertiary); }
...
.studio-list small, .filter-list small, .template-list small { font-size:12.5px; color:var(--text-tertiary); line-height:1.3; }
...
.filter-workflow span { display:flex; align-items:center; gap:7px; color:var(--text-secondary); font-size:12.5px; }
.filter-workflow b { width:18px; height:18px; border-radius:50%; display:inline-flex; align-items:center; justify-content:center; background:var(--accent-dim); color:var(--accent); font-size:11.5px; }
...
.filter-remove:hover { background:var(--bg-0); color:#b91c1c; }
.panel-empty.compact { padding:8px 2px; font-size:12.5px; }
...
.filter-contract-summary em { color:var(--text-tertiary); font-size:11.5px; font-style:normal; }
...
.filter-empty p { margin:0; color:var(--text-tertiary); font-size:12.5px; line-height:1.45; }
.filter-empty button, .filter-add-another { min-height:30px; border:1px solid var(--border-default); border-radius:8px; background:var(--bg-2); display:flex; align-items:center; justify-content:center; gap:5px; color:var(--text-primary); font-size:12.5px; font-weight:750; }
...
.filter-field-results small { color:var(--text-secondary); font-size:11.5px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }
...
.filter-builder > label > span, .filter-builder legend { color:var(--text-secondary); font-size:12px; font-weight:800; text-transform:uppercase; letter-spacing:.06em; }
...
.filter-availability > span { width:27px; height:27px; border-radius:7px; display:grid; place-items:center; color:var(--text-tertiary); background:var(--bg-0); }
.filter-availability > div { min-width:0; display:grid; gap:2px; }
.filter-availability strong { font-size:12.5px; }
.filter-availability small { color:var(--text-tertiary); font-size:11.5px; line-height:1.35; }
.filter-availability button { min-height:29px; border:1px solid var(--border-default); border-radius:7px; padding:0 8px; display:flex; align-items:center; gap:4px; background:var(--bg-2); color:var(--text-secondary); font-size:11.5px; font-weight:750; }
.filter-availability.ready { border-color:color-mix(in srgb,#16a34a 24%,var(--border-default)); background:color-mix(in srgb,#16a34a 5%,var(--bg-2)); }
.filter-availability.ready > span { color:#15803d; background:color-mix(in srgb,#16a34a 10%,var(--bg-2)); }
.filter-availability.empty { border-color:color-mix(in srgb,#d97706 32%,var(--border-default)); background:color-mix(in srgb,#d97706 5%,var(--bg-2)); }
.filter-availability.empty > span { color:#a16207; background:color-mix(in srgb,#d97706 10%,var(--bg-2)); }
...
.filter-builder-field small { color:var(--text-tertiary); font-size:11px; font-weight:800; letter-spacing:.07em; }
.filter-builder-field strong { font-size:13px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }
.filter-builder-field button { border:0; background:transparent; color:var(--accent); font-size:12px; font-weight:750; }
.filter-builder fieldset { min-width:0; margin:0; padding:0; border:0; display:grid; gap:6px; }
.filter-builder fieldset > small { color:var(--text-tertiary); font-size:11.5px; line-height:1.4; }
.filter-scope-switch { display:grid; grid-template-columns:1fr 1.35fr; gap:3px; border-radius:9px; padding:3px; background:var(--bg-0); }
.filter-scope-switch button { min-height:30px; border:0; border-radius:7px; background:transparent; color:var(--text-tertiary); font-size:12px; font-weight:750; }
...
.filter-mapping > header span { color:var(--text-tertiary); font-size:11.5px; }
.filter-mapping > header button { border:0; background:transparent; color:var(--accent); font-size:11.5px; font-weight:800; }
.filter-mapping > div { max-height:300px; overflow:auto; display:grid; gap:8px; }
.filter-mapping > div > section { display:grid; gap:4px; }
.filter-mapping > div > section > small { padding:3px 2px 1px; color:var(--text-secondary); font-size:11.5px; font-weight:800; text-transform:uppercase; letter-spacing:.06em; }
...
.filter-mapping label strong { font-size:12.5px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }
...
.filter-required strong { font-size:12.5px; }
.filter-required small { color:var(--text-tertiary); font-size:11.5px; font-weight:500; }
.filter-builder-actions { display:grid; grid-template-columns:1fr 1.5fr; gap:6px; padding-top:2px; }
.filter-builder-actions button { min-height:34px; border:1px solid var(--border-default); border-radius:8px; background:var(--bg-2); color:var(--text-secondary); font-size:12.5px; font-weight:800; }
...
.source-search-primary { position:sticky; top:-14px; z-index:3; display:grid; grid-template-columns:16px minmax(0,1fr) 24px; align-items:center; gap:7px; min-height:41px; margin:-3px 0 10px; padding:0 8px; border:1px solid var(--border-default); border-radius:10px; color:var(--text-tertiary); background:var(--bg-2); box-shadow:0 8px 16px color-mix(in srgb,var(--bg-2) 76%,transparent); }
...
.used-sources-disclosure summary > span { min-width:21px; height:20px; padding:0 6px; border-radius:10px; display:grid; place-items:center; background:var(--bg-0); color:var(--text-secondary); font-size:12px; font-weight:800; }
...
.source-catalog-toolbar > small { min-width:0; justify-self:end; color:var(--text-muted); font-size:11.5px; text-align:right; }
...
.source-view-tabs button { min-width:0; min-height:25px; padding:0 3px; border:0; border-radius:6px; color:var(--text-tertiary); background:transparent; font-size:12px; font-weight:750; }
...
.source-catalog-row { display:grid; grid-template-columns:minmax(0,1fr); border:1px solid var(--border-subtle); border-radius:10px; background:var(--bg-2); overflow:hidden; }
...
.source-catalog-summary small { color:var(--text-tertiary); font-size:11.5px; line-height:1.3; }
.source-add-view { min-height:28px; margin:0 8px 8px 45px; padding:5px 8px; border:1px solid color-mix(in srgb,var(--accent) 34%,var(--border-default)); border-radius:7px; background:var(--bg-2); color:var(--accent) !important; display:flex; align-items:center; justify-content:center; gap:4px; white-space:normal; line-height:1.25; font-size:12px; font-weight:800; }
...
.source-action-feedback { margin:-3px 8px 8px 45px; color:var(--text-tertiary); font-size:11.5px; line-height:1.35; overflow-wrap:anywhere; }
...
.source-catalog-detail > span { display:flex; align-items:center; gap:5px; color:var(--text-tertiary); font-size:11.5px; }
...
.source-view-options button { border:1px solid var(--border-default); background:var(--bg-2); border-radius:7px; padding:6px 3px; display:flex; justify-content:center; align-items:center; gap:4px; font-size:12.5px; }
.dataset-tile-builder { display:grid; gap:7px; padding:8px; border:1px solid color-mix(in srgb,var(--accent) 28%,var(--border-default)); border-radius:9px; background:var(--bg-2); }
.dataset-tile-builder > header { display:flex; align-items:flex-start; gap:6px; }
.dataset-tile-builder > header > span { width:24px; height:24px; flex:none; display:grid; place-items:center; border-radius:7px; color:var(--accent); background:var(--accent-dim); }
.dataset-tile-builder > header > div { display:grid; gap:2px; }
.dataset-tile-builder > header small { color:var(--accent); font-size:11px; font-weight:800; letter-spacing:.06em; }
.dataset-tile-builder > header strong { color:var(--text-primary); font-size:12.5px; line-height:1.35; }
.dataset-builder-description { margin:0; color:var(--text-secondary); font-size:11.5px; line-height:1.4; }
.dataset-tile-builder > label, .dataset-filter-builder { display:grid; gap:4px; min-width:0; }
.dataset-tile-builder > label > span, .dataset-filter-builder legend { color:var(--text-secondary); font-size:11.5px; font-weight:750; }
.dataset-tile-builder select, .dataset-tile-builder input { min-width:0; width:100%; box-sizing:border-box; border:1px solid var(--border-default); border-radius:6px; background:var(--bg-1); color:var(--text-primary); padding:5px 6px; font:inherit; font-size:12.5px; }
.dataset-tile-builder fieldset { min-width:0; margin:0; padding:6px; border:1px solid var(--border-subtle); border-radius:7px; }
...
.dataset-detail-limit { display:grid; grid-template-columns:minmax(0,1fr) 76px; gap:6px; align-items:center; color:var(--text-secondary); font-size:11.5px; }
...
.dataset-comparison-builder > legend { color:var(--text-secondary); font-size:11.5px; font-weight:750; }
...
.dataset-comparison-fields > label span, .dataset-comparison-periods label span, .dataset-comparison-advanced label span { font-weight:700; }
...
.tile-query-editor select, .tile-query-editor input:not([type=checkbox]):not([type=radio]) { min-width:0; width:100%; box-sizing:border-box; border:1px solid var(--border-default); border-radius:6px; background:var(--bg-1); color:var(--text-primary); padding:5px 6px; font:inherit; font-size:12.5px; }
...
.tile-query-editor legend, .dataset-editor-row label > span { color:var(--text-secondary); font-size:11.5px; font-weight:750; }
...
.dataset-sort-direction { display:inline-flex; align-items:center; justify-content:center; gap:4px; border:1px solid var(--border-default); border-radius:6px; background:var(--bg-1); color:var(--text-secondary); font:inherit; font-size:12px; padding:5px 6px; cursor:pointer; }
.dataset-sort-direction:disabled { opacity:.5; cursor:default; }
.dataset-measure-list label.is-suggested { opacity:.62; }
.dataset-field-badge { margin-left:auto; flex:none; border-radius:999px; padding:1px 6px; background:var(--bg-0); color:var(--text-tertiary); font-size:11px; font-style:normal; font-weight:700; }
...
.dataset-live-preview-table table { width:100%; border-collapse:collapse; font-size:11.5px; }
...
.dataset-link-hint { display:flex; flex-wrap:wrap; align-items:center; gap:6px; margin-top:4px; padding:4px 6px; border-radius:6px; background:var(--accent-dim); color:var(--text-secondary); font-size:11.5px; }
...
.dataset-filter-builder > div > button { flex:0 0 auto; padding:4px 6px; border:1px solid var(--border-default); border-radius:6px; background:var(--bg-1); color:var(--accent); display:flex; align-items:center; gap:3px; font-size:11.5px; font-weight:750; }
...
.dataset-binding-note { color:var(--text-tertiary); font-size:11.5px; line-height:1.35; }
.dataset-builder-error { color:#b91c1c; font-size:11.5px; line-height:1.35; }
.dataset-validate-source { width:100%; border:1px solid var(--accent); background:var(--accent-dim); color:var(--accent); border-radius:7px; padding:6px 8px; display:flex; align-items:center; justify-content:center; gap:5px; font-size:12.5px; font-weight:750; }
.dataset-validate-source:disabled { border-color:var(--border-default); background:var(--bg-0); color:var(--text-muted); cursor:default; }
.dataset-add-tile { width:100%; min-height:29px; justify-content:center; border:0; border-radius:7px; background:var(--accent); color:var(--accent-fg); display:flex; align-items:center; gap:5px; font-size:12.5px; font-weight:800; }
...
.dataset-query-inspector > label { color:var(--text-tertiary); font-size:12.5px; text-transform:uppercase; letter-spacing:.09em; font-weight:800; }
.dataset-query-inspector > p { margin:0; color:var(--text-secondary); font-size:12.5px; line-height:1.4; }
.dataset-inspector-measures { display:grid; gap:4px; max-height:136px; overflow:auto; }
.dataset-inspector-measures label { display:grid; grid-template-columns:auto minmax(0,1fr) auto; align-items:center; gap:5px; color:var(--text-primary); font-size:12.5px; text-transform:none; letter-spacing:0; }
.dataset-inspector-measures input { width:auto; margin:0; }
.dataset-inspector-measures small { color:var(--text-tertiary); font-size:11.5px; text-transform:none; letter-spacing:0; }
.dataset-inspector-row { display:grid; grid-template-columns:70px minmax(0,1fr); gap:6px; align-items:center; }
.dataset-inspector-row > span { color:var(--text-tertiary); font-size:12.5px; }
.dataset-inspector-row select, .dataset-inspector-filters select, .dataset-inspector-filters input { width:100%; min-width:0; box-sizing:border-box; border:1px solid var(--border-default); border-radius:6px; background:var(--bg-1); color:var(--text-primary); padding:6px; font:inherit; font-size:12.5px; }
.dataset-inspector-filters { min-width:0; margin:0; padding:7px; border:1px solid var(--border-subtle); border-radius:7px; }
.dataset-inspector-filters legend { color:var(--text-tertiary); font-size:11.5px; font-weight:750; }
.dataset-inspector-filters > div { display:flex; min-width:0; gap:4px; }
.dataset-inspector-filters > div > * { min-width:0; flex:1; }
.dataset-inspector-filters > div > button { flex:0 0 auto; border:1px solid var(--border-default); border-radius:6px; background:var(--bg-1); color:var(--accent); padding:4px 6px; display:flex; align-items:center; gap:3px; font-size:11.5px; font-weight:750; }
.dataset-change-source { width:100%; border:1px solid var(--border-default); border-radius:7px; background:var(--bg-1); color:var(--accent); padding:6px; display:flex; align-items:center; justify-content:center; gap:5px; font-size:12.5px; font-weight:750; }
...
.dataset-interaction-inspector > label { color:var(--text-tertiary); font-size:12.5px; text-transform:uppercase; letter-spacing:.09em; font-weight:800; }
.dataset-interaction-inspector > p { margin:0; color:var(--text-secondary); font-size:12.5px; line-height:1.4; }
.dataset-interaction-form { display:grid; gap:4px; }
.dataset-interaction-form select, .dataset-navigation-form select { width:100%; min-width:0; box-sizing:border-box; border:1px solid var(--border-default); border-radius:6px; background:var(--bg-1); color:var(--text-primary); padding:6px; font:inherit; font-size:12.5px; }
.dataset-interaction-form button, .dataset-navigation-form button, .dataset-detail-navigation { border:1px solid var(--border-default); border-radius:6px; background:var(--bg-1); color:var(--accent); padding:6px; font-size:12px; font-weight:750; }
...
.dataset-interaction-list > span { display:flex; align-items:center; gap:4px; border:1px solid var(--border-subtle); border-radius:99px; background:var(--bg-1); color:var(--text-secondary); padding:3px 5px; font-size:11.5px; }
...
.dataset-navigation-form > small { color:var(--text-secondary); font-size:12px; font-weight:750; }
.dataset-navigation-form > span { display:flex; gap:4px; }
.dataset-navigation-filters { display:grid; gap:3px; }
.dataset-navigation-filters label { display:flex; align-items:center; gap:5px; color:var(--text-secondary); font-size:11.5px; }
.dataset-navigation-filters input { width:auto; margin:0; }
.dataset-interaction-message { color:var(--text-tertiary); font-size:11.5px; line-height:1.35; }
.dataset-dql-receipt { display:grid; gap:5px; margin-top:7px; }
.dataset-dql-receipt summary { cursor:pointer; color:var(--accent); font-size:11.5px; font-weight:750; }
.dataset-dql-receipt p { margin:0; color:var(--text-tertiary); font-size:11.5px; line-height:1.35; }
.dataset-dql-receipt pre { max-height:180px; overflow:auto; margin:0; padding:7px; border:1px solid var(--border-subtle); border-radius:6px; background:var(--bg-1); color:var(--text-secondary); font:7.5px/1.4 ui-monospace, SFMono-Regular, Menlo, monospace; white-space:pre-wrap; overflow-wrap:anywhere; }
.dataset-execution-evidence { display:grid; gap:5px; }
.dataset-execution-evidence > small { color:var(--text-secondary); font-size:11.5px; font-weight:750; }
...
.panel-section-label span { color:var(--text-secondary); font-size:12.5px; font-weight:800; text-transform:uppercase; letter-spacing:.08em; }
.panel-section-label small { color:var(--text-muted); font-size:11.5px; }
...
.source-panel-state small { color:var(--text-tertiary); font-size:12.5px; line-height:1.4; overflow-wrap:anywhere; }
.source-panel-state.error { color:#b91c1c; border-color:color-mix(in srgb,#dc2626 34%,var(--border-default)); background:color-mix(in srgb,#dc2626 6%,var(--bg-2)); }
...
.used-source-list > div > span { width:29px; height:29px; border-radius:8px; flex:none; display:grid; place-items:center; color:#15803d; background:color-mix(in srgb,#16a34a 9%,var(--bg-2)); }
.used-source-list > div > span.review_required, .used-source-list > div > span.draft_ready { color:#a16207; background:color-mix(in srgb,#d97706 9%,var(--bg-2)); }
...
.source-review-lane { margin:8px 0 13px; padding:8px; border:1px solid color-mix(in srgb,#d97706 25%,var(--border-default)); border-radius:9px; background:color-mix(in srgb,#d97706 6%,var(--bg-2)); color:#a16207; display:flex; align-items:flex-start; gap:7px; }
.source-review-lane strong { color:var(--text-primary); font-size:12.5px; }
...
.studio-canvas { min-height:calc(100vh - 145px); background:var(--bg-2); border:1px solid var(--border-default); border-radius:14px; box-shadow:0 12px 36px color-mix(in srgb,var(--text-primary) 6%,transparent); padding:28px; }
...
.studio-page-heading > div > small { font-size:11.5px; font-weight:800; letter-spacing:.12em; color:var(--accent); }
...
.studio-source-ready { display:flex; align-items:center; justify-content:space-between; gap:12px; border:1px solid color-mix(in srgb,var(--accent) 28%,var(--border-default)); background:color-mix(in srgb,var(--accent-dim) 38%,var(--bg-2)); border-radius:10px; padding:8px 9px; margin-bottom:12px; }
...
.studio-source-ready p small { color:var(--text-tertiary); font-size:11.5px; }
...
.studio-source-actions > button { border:0; background:var(--accent); color:var(--accent-fg) !important; border-radius:7px; padding:7px 9px; display:flex; align-items:center; gap:5px; white-space:nowrap; font-size:12.5px; font-weight:800; }
...
.studio-filter > span, .studio-filter > label { color:var(--text-tertiary); font-size:11.5px; font-weight:750; }
...
.studio-filter.empty { border-color:color-mix(in srgb,#d97706 42%,var(--border-default)); background:color-mix(in srgb,#d97706 5%,var(--bg-2)); }
...
.studio-filter.dropdown > summary small { color:var(--text-tertiary); font-size:11.5px; font-weight:750; }
...
.studio-filter-menu { position:absolute; z-index:20; top:calc(100% + 5px); left:0; width:max(220px,100%); max-width:320px; padding:7px; border:1px solid var(--border-default); border-radius:9px; background:var(--bg-2); box-shadow:0 12px 28px color-mix(in srgb,var(--text-primary) 16%,transparent); display:grid; gap:5px; }
...
.studio-filter-menu > label input { min-width:0; flex:1; border:0; outline:0; background:transparent; color:var(--text-primary); font-size:12.5px; }
.studio-filter-menu > button, .studio-filter-menu > div > button { width:100%; min-height:28px; border:0; border-radius:6px; padding:5px 7px; background:transparent; color:var(--text-secondary); display:flex; align-items:center; gap:6px; text-align:left; font-size:12.5px; }
...
.studio-filter-menu > small { padding:7px; color:var(--text-muted); font-size:11.5px; }
...
.studio-component-card > header small { margin-left:auto; color:var(--text-tertiary); font-size:11.5px; text-transform:uppercase; }
.studio-autopilot-target { margin-left:auto; border:1px solid var(--border-default); border-radius:5px; padding:3px 5px; background:var(--bg-2); color:var(--text-secondary); font:inherit; font-size:11.5px; font-weight:700; line-height:1.1; white-space:nowrap; cursor:pointer; }
...
.tile-filter-notice { display:flex; align-items:center; gap:5px; margin:8px 10px 0; padding:6px 8px; border-radius:7px; background:var(--bg-0); color:var(--text-secondary); font-size:12.5px; line-height:1.35; }
...
.tile-text { padding:16px; font-size:13.5px; color:var(--text-secondary); line-height:1.55; }
...
.dataset-mark-controls > span { color:var(--text-tertiary); font-size:11px; font-weight:750; }
...
.studio-mark-filterbar > span { color:var(--accent); font-size:11.5px; font-weight:800; }
.studio-mark-filterbar button { display:flex; align-items:center; gap:3px; border:1px solid var(--border-default); border-radius:99px; background:var(--bg-2); color:var(--text-secondary); padding:3px 6px; font-size:11.5px; }
.studio-mark-filterbar button.clear { margin-left:auto; color:var(--accent); }
.studio-preview-incomplete { display:grid; gap:3px; margin:0 0 9px; padding:7px 9px; border:1px solid var(--border-default); border-radius:8px; background:var(--accent-dim); color:var(--text-secondary); font-size:12.5px; line-height:1.45; }
.studio-preview-incomplete strong { color:var(--text-primary); font-size:12.5px; }
...
.empty-canvas button { border:1px solid var(--border-default); border-radius:8px; background:var(--bg-1); padding:8px 12px; font-size:13px; font-weight:700; }
.studio-error { border:1px solid color-mix(in srgb,#dc2626 35%,var(--border-default)); background:color-mix(in srgb,#dc2626 8%,var(--bg-2)); color:#b91c1c; border-radius:9px; padding:10px 12px; font-size:13px; }
...
.field-help { color:var(--text-tertiary); font-size:12.5px; line-height:1.45; }
.review-action { border:1px solid var(--accent); background:var(--accent-dim); color:var(--accent); border-radius:8px; padding:9px; display:flex; align-items:center; justify-content:center; gap:6px; font-size:13px; font-weight:750; }
...
.review-task-list span { color:var(--text-secondary); font-size:12.5px; line-height:1.4; }
.review-task-list button { justify-self:start; border:0; background:transparent; color:var(--accent); padding:0; display:flex; gap:4px; align-items:center; font-size:12.5px; font-weight:750; }
.inspector-body label { color:var(--text-tertiary); font-size:12.5px; text-transform:uppercase; letter-spacing:.09em; font-weight:800; }
...
.field-mapping > div span, .format-grid > div span { color:var(--text-tertiary); font-size:12.5px; }
...
.ask-ai { border:0; background:var(--accent); color:var(--accent-fg) !important; border-radius:9px; padding:10px; display:flex; align-items:center; justify-content:center; gap:7px; font-size:13px; font-weight:800; }
...
.trust-summary p { margin:0; color:var(--text-tertiary); font-size:12.5px; line-height:1.4; }
.size-buttons { display:grid; grid-template-columns:1fr 1fr; gap:5px; }
.size-buttons button { border:1px solid var(--border-default); background:var(--bg-1); border-radius:7px; padding:7px; font-size:13px; }
...
.delete-component { border:1px solid color-mix(in srgb,#dc2626 25%,var(--border-default)); color:#b91c1c !important; background:transparent; border-radius:8px; padding:9px; display:flex; align-items:center; justify-content:center; gap:6px; font-size:13px; }
.inspector-id { color:var(--text-muted); font-size:11.5px; text-align:center; }

.studio-ai-plan { width:min(920px,100%); margin:0 auto; box-sizing:border-box; border:1px solid var(--border-default); background:var(--bg-2); border-radius:18px; box-shadow:0 18px 52px color-mix(in srgb,var(--text-primary) 9%,transparent); overflow:hidden; }
...
.studio-ai-plan > header small { color:var(--accent); font-size:11.5px; font-weight:800; letter-spacing:.1em; }
...
.studio-ai-plan > header .proposal-planner-provenance { color:var(--text-tertiary); font-size:12px; font-weight:700; letter-spacing:0; }
...
.proposal-source-heading h2 { margin:0; font-size:13.5px; }
.proposal-source-heading p { margin:0; color:var(--text-tertiary); font-size:12px; }
.proposal-source-heading > strong { min-width:25px; height:25px; display:grid; place-items:center; border-radius:999px; color:var(--accent); background:var(--accent-dim); font-size:12.5px; }
...
.proposal-source-trust, .proposal-catalog-list > article > span { width:34px; height:34px; border-radius:9px; display:grid; place-items:center; color:#15803d; background:color-mix(in srgb,#16a34a 9%,var(--bg-2)); }
.proposal-source-trust.review_required, .proposal-source-trust.draft_ready, .proposal-catalog-list > article > span.review_required { color:#a16207; background:color-mix(in srgb,#d97706 9%,var(--bg-2)); }
...
.proposal-source-row > button, .proposal-catalog-list > article > button { border:1px solid var(--border-default); background:var(--bg-2); border-radius:8px; padding:7px 9px; display:flex; align-items:center; gap:5px; color:var(--accent); font-size:12px; font-weight:800; }
...
.studio-ai-review-lane strong { color:var(--text-primary); font-size:12.5px; }
.studio-ai-review-lane small { color:var(--text-tertiary); font-size:12px; line-height:1.4; }
.studio-ai-plan-empty { margin:0; color:var(--text-tertiary); font-size:12.5px; line-height:1.45; padding:12px; border:1px dashed var(--border-default); border-radius:9px; }
.studio-ai-questions { border:1px solid color-mix(in srgb,#d97706 28%,var(--border-default)); background:color-mix(in srgb,#d97706 6%,var(--bg-2)); border-radius:10px; padding:11px; display:grid; gap:8px; }
...
.studio-ai-questions > header small { color:#a16207; font-size:12px; }
.studio-ai-questions > p { margin:0; color:var(--text-secondary); font-size:12.5px; line-height:1.45; }
.studio-ai-questions button { justify-self:start; border:1px solid var(--accent); color:var(--accent); background:var(--accent-dim); border-radius:8px; padding:7px 9px; font-size:12px; font-weight:750; }
...
.studio-ai-plan > footer button { border:1px solid var(--border-default); background:var(--bg-1); border-radius:9px; padding:9px 12px; font-size:12.5px; font-weight:750; }
...
.inspector-body .tile-query-editor label, .inspector-body .tile-query-editor legend { color:var(--text-secondary); font-size:12.5px; text-transform:none; letter-spacing:normal; font-weight:650; }
...
.inspector-body .tile-query-editor input:not([type=checkbox]):not([type=radio]), .inspector-body .tile-query-editor select { padding:5px 7px; font-size:13px; border-radius:6px; }
...
.tile-query-editor .dataset-builder-mode strong, .tile-query-editor .dataset-comparison-toggle strong { color:var(--text-primary); font-size:12.5px; text-transform:none; letter-spacing:normal; }
.tile-query-editor .dataset-builder-mode small, .tile-query-editor .dataset-comparison-toggle small { color:var(--text-tertiary); font-size:11.5px; font-weight:500; text-transform:none; letter-spacing:normal; }
...
.studio-ai-scope button { flex:1; min-width:0; border:0; border-radius:7px; background:none; color:var(--text-secondary); font:inherit; font-size:13.5px; padding:6px 8px; cursor:pointer; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }
.studio-ai-scope button.on { background:var(--bg-2); color:var(--text-primary); font-weight:650; box-shadow:0 1px 2px color-mix(in srgb,var(--text-primary) 12%,transparent); }
...
.studio-ai-page-scope textarea { width:100%; box-sizing:border-box; resize:vertical; border:1px solid var(--border-default); border-radius:8px; background:var(--bg-2); color:var(--text-primary); font:inherit; font-size:12.5px; padding:8px; }
...
.studio-copilot-change > header small { color:var(--accent); font-size:11.5px; font-weight:800; letter-spacing:.1em; }
...
.studio-copilot-change > p { margin:0; color:var(--text-secondary); font-size:12.5px; line-height:1.45; }
.studio-copilot-change label { display:grid; gap:5px; color:var(--text-secondary); font-size:12.5px; font-weight:750; }
...
.studio-copilot-change-summary { display:grid; gap:3px; border:1px solid var(--border-subtle); border-radius:9px; background:var(--bg-2); padding:9px; }
.studio-copilot-change-summary strong { font-size:13px; }
.studio-copilot-change-summary span { color:var(--accent); font-size:12.5px; }
.studio-copilot-change-summary small { color:var(--text-tertiary); font-size:12px; line-height:1.4; }
.studio-copilot-diagnostic { margin:0; border-left:2px solid var(--accent); padding-left:8px; color:var(--text-secondary); font-size:12.5px; line-height:1.4; }
.studio-copilot-change footer { display:flex; justify-content:flex-end; gap:7px; }
.studio-copilot-change footer button { border:1px solid var(--border-default); border-radius:8px; background:var(--bg-2); padding:7px 9px; font-size:12.5px; font-weight:750; }
...
.proposal-card { width:min(620px,100%); max-height:calc(100vh - 48px); overflow:auto; border:1px solid var(--border-default); background:var(--bg-2); border-radius:16px; box-shadow:0 24px 80px color-mix(in srgb,var(--text-primary) 18%,transparent); }
...
.proposal-summary span { color:var(--text-tertiary); font-size:12.5px; }
.proposal-clarifications { margin:0 18px 14px; border:1px solid color-mix(in srgb,#d97706 30%,var(--border-default)); background:color-mix(in srgb,#d97706 7%,var(--bg-2)); border-radius:9px; padding:11px; display:grid; gap:9px; }
.proposal-clarifications > strong { font-size:13px; color:#a16207; }
...
.proposal-clarifications button { border:1px solid var(--border-default); background:var(--bg-2); border-radius:999px; padding:5px 8px; font-size:12.5px; }
...
.proposal-card > footer button { border:1px solid var(--border-default); background:var(--bg-1); border-radius:8px; padding:9px 12px; font-size:13px; font-weight:700; }
...
.studio-readiness-card { width:min(680px,100%); max-height:calc(100vh - 48px); overflow:hidden; display:flex; flex-direction:column; border:1px solid var(--border-default); background:var(--bg-2); border-radius:18px; box-shadow:0 24px 80px color-mix(in srgb,var(--text-primary) 18%,transparent); }
...
.studio-readiness-card > header > span { width:38px; height:38px; flex:none; border-radius:11px; display:grid; place-items:center; color:#a16207; background:color-mix(in srgb,#d97706 9%,var(--bg-2)); }
.studio-readiness-card > header > span.ready { color:#15803d; background:color-mix(in srgb,#16a34a 9%,var(--bg-2)); }
...
.readiness-item.warning { border-color:color-mix(in srgb,#d97706 28%,var(--border-default)); background:color-mix(in srgb,#d97706 5%,var(--bg-2)); }
...
.readiness-item.warning .step-mark { color:#a16207; background:color-mix(in srgb,#d97706 10%,var(--bg-2)); }
...
.readiness-item small { color:var(--text-tertiary); font-size:12.5px; line-height:1.4; }
.readiness-actions, .readiness-choices { margin-top:5px; display:flex; gap:6px; flex-wrap:wrap; }
.readiness-actions button, .readiness-choices button { border:1px solid var(--border-default); background:var(--bg-2); border-radius:7px; padding:7px 9px; display:inline-flex; align-items:center; gap:5px; color:var(--text-secondary); font-size:12.5px; font-weight:750; }
...
.readiness-ready { border:1px solid color-mix(in srgb,#16a34a 25%,var(--border-default)); background:color-mix(in srgb,#16a34a 6%,var(--bg-2)); border-radius:11px; padding:14px; display:flex; align-items:flex-start; gap:9px; color:#15803d; }
.readiness-ready > div { display:grid; gap:3px; }
.readiness-ready strong { color:var(--text-primary); font-size:13px; }
.readiness-ready span { color:var(--text-secondary); font-size:12.5px; line-height:1.45; }
...
.studio-readiness-card > footer button { border:1px solid var(--border-default); background:var(--bg-1); border-radius:8px; padding:9px 12px; font-size:13px; font-weight:750; }
...
.readiness-footer-hint { flex:1; color:var(--text-tertiary); font-size:12.5px; text-align:right; }
.studio-delete-card { width:min(420px,100%); border:1px solid var(--border-default); background:var(--bg-2); border-radius:16px; padding:24px; box-shadow:0 24px 80px color-mix(in srgb,var(--text-primary) 18%,transparent); }
.studio-delete-card .delete-mark { width:40px; height:40px; border-radius:11px; display:flex; align-items:center; justify-content:center; color:#b91c1c; background:color-mix(in srgb,#dc2626 9%,var(--bg-2)); }
...
.studio-delete-card footer button { border:1px solid var(--border-default); background:var(--bg-1); border-radius:8px; padding:9px 12px; font-size:13px; font-weight:750; }
.studio-delete-card footer button.danger { border-color:#dc2626; background:#dc2626; color:white; }
.dataset-author-source { width:100%; margin-top:9px; border:1px solid var(--border-default); background:var(--bg-1); color:var(--text-secondary); border-radius:8px; padding:8px 9px; display:flex; align-items:center; justify-content:center; gap:6px; font-size:13px; font-weight:750; }
.dataset-author-source:hover:not(:disabled) { border-color:var(--accent); color:var(--accent); background:var(--accent-dim); }
.dataset-source-authoring-card { width:min(760px,100%); max-height:calc(100vh - 48px); overflow:hidden; display:flex; flex-direction:column; border:1px solid var(--border-default); background:var(--bg-2); border-radius:16px; box-shadow:0 24px 80px color-mix(in srgb,var(--text-primary) 18%,transparent); }
...
.dataset-source-authoring-card > header > span { width:36px; height:36px; flex:none; display:grid; place-items:center; border-radius:10px; color:var(--accent); background:var(--accent-dim); }
.dataset-source-authoring-card > header > div { flex:1; min-width:0; display:grid; gap:3px; }
.dataset-source-authoring-card > header small { color:var(--text-tertiary); font-size:12.5px; letter-spacing:.07em; font-weight:800; }
.dataset-source-authoring-card h2 { margin:0; font-size:18px; letter-spacing:-.02em; }
.dataset-source-authoring-card header p { margin:0; color:var(--text-secondary); font-size:13px; overflow-wrap:anywhere; }
.dataset-source-authoring-card header code { color:var(--text-tertiary); font-size:12.5px; }
...
.dataset-source-authoring-body > section { border:1px solid var(--border-subtle); border-radius:10px; background:var(--bg-1); padding:11px; display:grid; gap:8px; }
.dataset-source-authoring-body > section > label { color:var(--text-primary); font-size:13px; font-weight:800; }
.dataset-source-authoring-body > section > p, .dataset-source-authoring-body > section > small { margin:0; color:var(--text-secondary); font-size:12.5px; line-height:1.45; }
...
.dataset-source-checkbox { display:flex !important; align-items:center; gap:7px; align-self:end; min-height:31px; color:var(--text-secondary); font-size:12.5px; }
...
.dataset-source-fields > div > span { min-width:184px; flex:1 1 184px; display:grid; gap:5px; padding:7px 8px; border:1px solid var(--border-subtle); border-radius:7px; background:var(--bg-2); }
.dataset-source-fields strong { font-size:12.5px; overflow-wrap:anywhere; }
.dataset-source-fields small { color:var(--text-tertiary); font-size:12px; }
.dataset-source-field-editor > label { display:grid; gap:3px; }
.dataset-source-field-editor > label > span { color:var(--text-tertiary); font-size:11.5px; font-weight:750; }
...
.dataset-source-candidates strong { color:var(--text-primary); font-size:12.5px; }
...
.dataset-source-form-grid span, .dataset-source-expression > span { color:var(--text-tertiary); font-size:12px; font-weight:750; }
.dataset-source-authoring-card input, .dataset-source-authoring-card select, .dataset-source-authoring-card textarea { min-width:0; width:100%; box-sizing:border-box; border:1px solid var(--border-default); background:var(--bg-2); color:var(--text-primary); border-radius:7px; padding:7px 8px; font:inherit; font-size:13px; }
...
.dataset-source-authoring-message { margin:0; border:1px solid color-mix(in srgb,#d97706 30%,var(--border-default)); background:color-mix(in srgb,#d97706 7%,var(--bg-2)); border-radius:8px; padding:9px; color:var(--text-secondary); font-size:12.5px; line-height:1.45; }
...
.dataset-source-authoring-card > footer > span { flex:1; color:var(--text-tertiary); font-size:12.5px; line-height:1.4; }
.dataset-source-authoring-card > footer button { border:1px solid var(--border-default); background:var(--bg-1); color:var(--text-primary); border-radius:8px; padding:9px 11px; font-size:13px; font-weight:750; }
...
.dataset-source-rebind-card { width:min(470px,100%); border:1px solid var(--border-default); background:var(--bg-2); border-radius:14px; box-shadow:0 24px 80px color-mix(in srgb,var(--text-primary) 18%,transparent); overflow:hidden; }
...
.dataset-source-rebind-card > header > span { width:34px; height:34px; display:grid; place-items:center; flex:none; color:var(--accent); background:var(--accent-dim); border-radius:9px; }
.dataset-source-rebind-card > header > div { flex:1; display:grid; gap:2px; }
.dataset-source-rebind-card > header small { color:var(--text-tertiary); font-size:12.5px; font-weight:800; letter-spacing:.06em; }
.dataset-source-rebind-card h2 { margin:0; font-size:17px; letter-spacing:-.02em; }
...
.dataset-source-rebind-card > footer button { border:1px solid var(--border-default); background:var(--bg-1); color:var(--text-primary); border-radius:8px; padding:9px 10px; font-size:13px; font-weight:750; }
...
.studio-brand .mark { width:26px; height:26px; border-radius:7px; }
.studio-brand input { width:200px; font-size:14px; font-weight:650; }
.studio-brand small { font-size:11.5px; max-width:210px; }
...
.mode-toggle { display:flex; padding:3px; border-radius:9px; background:var(--bg-0); }
.mode-toggle button { height:26px; padding:0 12px; border:0; border-radius:7px; background:transparent; color:var(--text-secondary); font-size:12.5px; font-weight:500; }
...
.studio-overflow-menu { top:42px; right:0; width:228px; padding:6px; border-radius:10px; display:grid; }
...
.studio-overflow-menu button.danger { color:#b91c1c; }
.studio-overflow-menu button.danger:hover { background:color-mix(in srgb,#dc2626 9%,var(--bg-2)); }
...
.studio-list strong, .template-list strong { font-size:13.5px; font-weight:600; }
...
.studio-page-heading h1 { margin:0; font-size:22px; font-weight:650; letter-spacing:-.01em; line-height:1.25; }
.studio-page-heading p { margin:4px 0 0; max-width:760px; color:var(--text-secondary); font-size:13.5px; line-height:1.45; }
...
.studio-filter.dropdown > summary small { color:var(--text-secondary); font-size:12.5px; font-weight:500; }
...
.studio-page-filterbar .studio-filter > span, .studio-page-filterbar .studio-filter > label { color:var(--text-secondary); font-size:12.5px; font-weight:500; white-space:nowrap; }
...
.studio-component-card > header strong { font-size:13.5px; font-weight:600; }
...
.tile-tools > button { width:28px; height:28px; margin:0; padding:0; border:0; border-radius:7px; background:transparent; color:var(--text-secondary); display:inline-flex; align-items:center; justify-content:center; }
...
.tile-menu { position:absolute; top:32px; right:0; z-index:25; width:214px; padding:6px; border:1px solid var(--border-default); border-radius:10px; background:var(--bg-2); box-shadow:0 12px 32px color-mix(in srgb,var(--text-primary) 14%,transparent); display:grid; cursor:default; }
.tile-menu button { height:32px; border:0; border-radius:7px; background:transparent; padding:0 9px; display:flex; align-items:center; gap:9px; color:var(--text-primary); font-size:13px; text-align:left; }
.tile-menu button:hover { background:var(--bg-0); }
.tile-menu button.danger { color:#b91c1c; }
...
.tile-heading { padding:2px 14px 12px; font-size:18px; font-weight:650; }
.tile-text { padding:2px 14px 14px; font-size:13.5px; }
.empty-canvas { min-height:360px; border-radius:14px; background:var(--bg-2); }
.empty-canvas strong { font-size:15px; }
.empty-canvas p { font-size:13.5px; max-width:380px; line-height:1.5; }
...
.studio-right > header strong { color:var(--text-secondary); font-size:12.5px; font-weight:500; }
...
.chart-type-grid button { height:56px; border:1px solid var(--border-subtle); border-radius:9px; background:var(--bg-2); color:var(--text-secondary); display:flex; flex-direction:column; align-items:center; justify-content:center; gap:4px; font-size:12px; }
...
.run-state.ok::before { background:#16a34a; }
.run-state.error::before { background:#dc2626; }
.inspector-footer .delete-component { width:auto; height:30px; padding:0 10px; border:0; border-radius:7px; background:transparent; font-size:12.5px; font-weight:500; }
.inspector-footer .delete-component:hover { background:color-mix(in srgb,#dc2626 9%,var(--bg-2)); }
...
.live-component-preview .dql-kpi-value { font-family:inherit !important; font-size:clamp(26px,2.4vw,34px) !important; font-weight:650 !important; letter-spacing:-.02em; color:var(--text-primary) !important; }
...
.dql-studio-v2 .dataset-detail-navigation { width:auto; margin:6px 2px 0 auto; display:flex; align-items:center; gap:4px; border:0; background:transparent; color:var(--accent); font-size:12.5px; font-weight:600; padding:4px 6px; border-radius:6px; }
...
@media (max-width:620px) {
  ...
  .dataset-source-authoring-card { max-height:calc(100vh - 20px); border-radius:15px 15px 0 0; }
