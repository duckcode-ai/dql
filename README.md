...
```bash
npm install @duckcodeailabs/dql-core@0.8.6 @duckcodeailabs/dql-compiler@0.8.6 @duckcodeailabs/dql-notebook@0.8.6
```
...
All packages share a unified version number (`0.8.6`).
