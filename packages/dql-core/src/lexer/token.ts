...
export enum TokenType {
  ...
  TermsKeyword = 'TermsKeyword',
  BusinessViewKeyword = 'BusinessViewKeyword',
...
const KEYWORDS: Record<string, TokenType> = {
  ...
  term: TokenType.TermKeyword,
  terms: TokenType.TermsKeyword,
  business_view: TokenType.BusinessViewKeyword,
  includes: TokenType.IncludesKeyword,
